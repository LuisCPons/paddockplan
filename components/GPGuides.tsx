...
const GUIDES = [
  {
    ...
    description: 'Master the technicality of the Rettifilo and the high-speed commitment of the Parabolica.',
    tag: 'HIGH SPEED',
    tagIcon: Gauge,
  ...
  },
  {
    ...
    description: 'Navigate the legendary Maggots, Becketts, and Chapel sequence where legends are made.',
    tag: 'LEGENDARY',
    tagIcon: Sparkles,
  ...
  },
  {
    ...
    description: 'Conquer the technical rhythm of Montmeló, from Turn 1 braking to the high-wear final sector.',
    tag: 'TECHNICAL',
    tagIcon: Settings,
      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 p-8 w-full">
          <div className="flex items-center gap-2 mb-2">
            ...
            <img 
              src={`https://flagcdn.com/w40/${guide.countryCode}.png`}
              alt=""
              className="h-3 w-auto border border-white/80 rounded-[1px]" 
            />
          </div>
          <h3 
          ...
          {/* Red Line Accent */}
          <div className="w-8 h-0.5 bg-accent mb-4 transition-all duration-500 group-hover:w-16 shadow-[0_0_8px_rgba(225,6,0,0.5)]" />
