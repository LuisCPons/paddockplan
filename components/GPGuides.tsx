...
const GUIDES = [
  {
    ...
    flag: '🇮🇹',
    image: 'https://www.studio-397.com/wp-content/uploads/2021/06/monza_2021_screen_16.jpg',
    description: 'Experience the Temple of Speed. Master the technicality of the Rettifilo and the high-speed commitment of the Parabolica in the heart of Lombardy.',
    tag: 'HIGH SPEED',
    tagIcon: Gauge,
  ...
  },
  {
    ...
    flag: '🇬🇧',
    image: 'https://coachdaveacademy.com/wp-content/uploads/2023/07/banner-image-silverstonetg-1.jpg',
    description: 'Navigate the home of British racing. A high-octane guide to the legendary Maggots, Becketts, and Chapel sequence where legends are made.',
    tag: 'LEGENDARY',
    tagIcon: Sparkles,
  ...
  },
  {
    ...
    flag: '🇪🇸',
    image: 'https://www.circuitcat.com/wp-content/uploads/2026/01/2506012146-scaled.jpg',
    description: 'Conquer the ultimate technical test. From the heavy braking of Turn 1 to the high-wear final sector, master the rhythm of Montmeló.',
    tag: 'TECHNICAL',
    tagIcon: Settings,
    ...
    >
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 p-8 w-full">
          ...
          <h3 className="text-2xl font-bold tracking-tight text-white mb-2" style={{ textShadow: '0px 2px 4px rgba(0,0,0,0.5)' }}>
            {guide.title}
          </h3>
