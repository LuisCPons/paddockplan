...
function GuideCard({ guide }: { guide: any }) {
  return (
    <motion.div 
      ...
      className="group relative flex flex-col bg-card border border-border hover:border-accent transition-colors cursor-pointer"
    >
      ...
      <div className="p-8">
        <div className="flex items-center justify-between mb-4">
          <span className="text-xs font-bold uppercase tracking-widest text-muted-foreground">{guide.location}</span>
        ...
        <p className="text-muted-foreground text-sm font-light leading-relaxed">Master the weekend with our comprehensive editorial guide to {guide.location.split(',')[0]}.</p>
      </div>
    </motion.div>
  );
}
