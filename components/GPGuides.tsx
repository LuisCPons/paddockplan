...
const GUIDES = [
  {
    ...
    flag: '🇮🇹',
    image: 'https://images.unsplash.com/photo-1534440477138-03823098e980?auto=format&fit=crop&q=80&w=800',
    tag: 'HIGH SPEED',
    tagIcon: Gauge,
  ...
  },
  {
    ...
    flag: '🇬🇧',
    image: 'https://images.unsplash.com/photo-1628153401563-7da9f8646f90?auto=format&fit=crop&q=80&w=800',
    tag: 'LEGENDARY',
    tagIcon: Sparkles,
  ...
  },
  {
    ...
    flag: '🇪🇸',
    image: 'https://images.unsplash.com/photo-1541441324707-160a37e8340d?auto=format&fit=crop&q=80&w=800',
    tag: 'TECHNICAL',
    tagIcon: Settings,
    ...
    >
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        <div 
          ...
          style={{ backgroundImage: 'linear-gradient(to bottom, transparent 0%, rgba(0,0,0,0.8) 100%)' }} 
        />
