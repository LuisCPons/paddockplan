...
function CircuitSchematicEngine() {
  ...
  // Authentic Track Geometry (Verification Level: Multi-Circuit High-Precision)
  const circuits = [
    { 
      name: 'Monza', 
  ...
  const currentCircuit = circuits[index];
    ...
    <AnimatePresence mode="wait">
      ...
      >
        ...
        >
          ...
          >
            ...
            <motion.path
              ...
              transition={{ duration: currentCircuit.duration, ease: "linear" }}
        ...
        <div className="flex flex-col items-center gap-5">
          ...
          >
            <span className="text-white font-black">{currentCircuit.name.toUpperCase()}</span>
          </motion.div>
        </div>
      </motion.div>
    </AnimatePresence>
