  ...
  monza: {
    ...
    stayZones: [
      ...
      },
      {
        ...
        mapUrl: 'https://www.google.com/maps/search/?api=1&query=Brera&query_place_id=ChIJCYiuC7PGhkcRz09nwZLNenU'
      }
    ],
    logistics: {
      publicTransport: {
    ...
    stayZones: [
      {
        ...
        mapUrl: 'https://www.google.com/maps/search/?api=1&query=Milton+Keynes&query_place_id=ChIJhYYjgvhMdkgRFH65TPedGhY'
      },
      {
        ...
        mapUrl: 'https://www.google.com/maps/search/?api=1&query=Northampton&query_place_id=ChIJbwMro9YOd0gRwOXCu6gcDgQ'
      },
      {
        neighborhood: 'Oxford',
        ...
        mapUrl: 'https://www.google.com/maps/search/?api=1&query=Oxford&query_place_id=ChIJrx_ErYAzcUgRAnRUy6jbIMg'
      }
    ],
    logistics: {
      publicTransport: {
  ...
  barcelona: {
    ...
    stayZones: [
      ...
      },
      {
        ...
        connectionTime: '60 mins',
        mapUrl: 'https://www.google.com/maps/search/?api=1&query=El+Poblenou&query_place_id=ChIJoa4TSxWjpBIRM9ft9a1VYHo'
      },
      {
        ...
        mapUrl: 'https://www.google.com/maps/search/?api=1&query=Granollers&query_place_id=ChIJbURCQs_HpBIRKKK8bxRfexw'
      }
    ],
    logistics: {
      publicTransport: {
