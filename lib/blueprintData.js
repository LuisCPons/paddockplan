export const BLUEPRINT_DETAILS = {
  monza: {
    ...
    transportTimeline: {
      train: {
        friday: { departure: '08:30', return: '18:00', note: 'Shuttles from Monza Station' },
        saturday: { departure: '07:30', return: '19:00', note: 'Shuttles from Monza Station' },
        sunday: { departure: '06:30', return: '19:30', note: 'Black Shuttle is fastest' }
      },
      car: {
